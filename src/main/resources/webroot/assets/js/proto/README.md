...
ProtoBuf.js is available either with or without the .idl parser included.

### Full build including .idl parser (.idl and JSON)
...
### Light build excluding .idl parser (JSON only) for use with [pbjs](https://github.com/dcodeIO/Protobuf.js/wiki/pbjs)
